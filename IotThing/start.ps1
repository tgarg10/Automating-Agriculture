...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e a30yw3b7o87nrw-ats.iot.us-east-1.amazonaws.com -r root-CA.crt -c esp32-cam0.cert.pem -k esp32-cam0.private.key
